...
/// alone and the result comes back empty, which is not an error. A material
/// whose sources will not decode keeps the slots the derive wrote.
///
...
Sc2PbrBakeResult BakeSc2AsReforgedPbr(::whiteout::models::wem::Document& document,
                                      io::IContentProvider* provider,
                                      const ::whiteout::textures::pbr::NormalRestatement& normal,
                                      ::whiteout::models::wem::Diagnostics& out,
