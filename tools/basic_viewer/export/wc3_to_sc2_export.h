...
/// The Warcraft III replaceable texture ids the export spends.
inline constexpr u32 kReplaceableTeamColor = 1;
inline constexpr u32 kReplaceableTeamGlow = 2;
inline constexpr u32 kReplaceableCliff = 11;
inline constexpr u32 kReplaceableTreeFirst = 31;
inline constexpr u32 kReplaceableTreeLast = 37;
...
Wc3ToSc2Result RestateWc3AsSc2(::whiteout::models::wem::Document& document,
                               io::IContentProvider* provider,
                               ::whiteout::models::wem::Diagnostics& diagnostics,
                               const Wc3ToSc2Options& options = {});

/// Warcraft III's hero glow ramp in white, RGBA8 at the size the renderer
/// synthesizes it. Nothing when the ramp would not decode.
std::optional<::whiteout::textures::Texture> WhiteTeamGlow();
