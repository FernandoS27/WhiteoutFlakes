...
Wc3TargetVolume Wc3TargetVolumeOf(const models::wem::Model& model) {
    ...
    Vector3f lo{1e30f, 1e30f, 1e30f};
    Vector3f hi{-1e30f, -1e30f, -1e30f};
    bool any = false;
    ...
    // 1.44 times the half extent in StarCraft II units, the axes swapped as
    // the basis swaps them.
    constexpr f32 k = 0.0144f;
    volume.scale = Vector3f{k * half.y, k * half.x, k * half.z};
