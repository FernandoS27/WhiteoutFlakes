...
void RecipeFromIni(const IniMap& m, ExportRecipe& r, std::span<const std::string> seqNames,
    ...
    {
        i32 rgb = static_cast<i32>(tools::PackRgb({o.backgroundR, o.backgroundG, o.backgroundB}));
        GetI32(m, "Export.Background", rgb);
        const tools::Rgb8 c = tools::UnpackRgb(static_cast<u32>(rgb));
        o.backgroundR = c.r;
        o.backgroundG = c.g;
        o.backgroundB = c.b;
    }
...
void RecipeToIni(IniMap& m, const ExportRecipe& r, std::span<const std::string> seqNames,
    ...
    m.Set("Export.Background", ini::ToString(static_cast<i32>(
                                   tools::PackRgb({o.backgroundR, o.backgroundG, o.backgroundB}))));
