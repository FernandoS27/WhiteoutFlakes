...
// Every format's description, indexed by ExportFormat — the order must match the enum.
inline constexpr std::array<ExportFormatInfo, 7> kExportFormats = {{
...
inline constexpr i32 kExportFormatCount = static_cast<i32>(kExportFormats.size());
