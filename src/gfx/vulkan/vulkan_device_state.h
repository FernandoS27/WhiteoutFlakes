...
// t16..t18), VS t16 (the >256-bone palette) at 48, VS t17 (the mesh overlay's
// elements) at 49. cb_structs.slang and mesh_overlay.slang declare the same
// numbers.
inline constexpr u32 kStorageBindings[] = {32, 33, 34, 35, 48, 49};
