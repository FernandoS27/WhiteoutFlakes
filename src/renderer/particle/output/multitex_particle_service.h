...
// ============================================================================
// MultiTexParticleService — WoW's `MultiTexture` particles: three textures, three
// UV sets, so their own vertex stream and pipeline; blend, depth and sort as a
// plain particle's. Owns shaders, PSO cache, CBs and VB, and draws INSIDE the
// caller's open pass (unlike RefractionService). Combiner: M2_MULTITEX_DESIGN.md;
// see also M2_PARTICLE_DESIGN.md §11.14.
// ============================================================================
