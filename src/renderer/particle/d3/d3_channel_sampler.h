...
// ============================================================================
// One `.prt` channel read at one site. Binding the desc, seed and context once
// means each read names its channel id once: a mistyped id would silently sample
// another channel's random stream. Evaluation is stateless, so reading through
// the sampler is the same number as reading the path, in any order.
// ============================================================================
