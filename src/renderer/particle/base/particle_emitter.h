...
// ============================================================================
// ParticleEmitter — what the service and the actor layer hold: the dialect-blind
// operations, plus the pool, placement, surface and per-frame enable every
// dialect keeps. `Emitter2` (WC3, WoW, SC2) and `d3::Emitter` implement it side
// by side; a caller needing one dialect's surface asks `AsEmitter2` / `AsD3`.
