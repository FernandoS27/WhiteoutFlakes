...
// simulation and builders read, named once by ROLE (`sc2_constants.h`'s rule) —
// one float in two roles is two names over one definition. SC2 and Diablo III
// keep their own vocabularies. See M2_PARTICLE_DESIGN.md §11.14.
// ============================================================================
...
/// Mixed into the emitter seed for an SC2 runtime's `renderer::sc2::Rng`, and for a
