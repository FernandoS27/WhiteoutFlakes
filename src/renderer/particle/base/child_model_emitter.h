...
// ============================================================================
// Child-model particles — particles that ARE models (MDX PE1). A billboard
// emitter's sim; only the output differs, through the birth/death hooks. The
// emitter never touches actors: it reports Birth / Transform / Death as data for
// FrameTicker to drain. See M2_PARTICLE_DESIGN.md §11.14.
// ============================================================================
