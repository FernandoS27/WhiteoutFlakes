...
// ============================================================================
// Spawn shapes — where a particle is born and which way it heads. Stateless and
// shared on the EmitterDesc; everything animated (plane size, cone angle, speed)
// arrives per sample in SpawnParams. Orthogonal to the output: a cone emitting
// child models is ConeShape plus a child-model output, not a new class.
// ============================================================================
