...
struct MatParams {
    ...
    bool LightingEnabled() const {
        return (disables & kDisableLighting) == 0;
    }
    bool FogEnabled() const {
        return (disables & kDisableFog) == 0;
    }
    bool DepthTestEnabled() const {
        return (disables & kDisableDepthTest) == 0;
    }
    bool DepthWriteEnabled() const {
        return (disables & kDisableDepthWrite) == 0;
    }
    bool CullEnabled() const {
        return (disables & kDisableCull) == 0;
    }

    bool ColorWriteEnabled() const {
        return (disables & kDisableBit8) == 0;
    }
};
