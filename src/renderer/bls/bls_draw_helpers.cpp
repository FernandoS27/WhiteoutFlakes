...
i32 BuildLightPalette(FrameInputs& frame, const std::vector<FrameState::LightState>& activeLights,
    ...
    if (addBaseline) {
        ...
        sl.position = {baseline.dirToSourceVS.x, baseline.dirToSourceVS.y, baseline.dirToSourceVS.z,
                       0.0f};
    }
